...
win_path = r'C:\Users\myuser\serverless-benchmarker\tests\fixtures\mock_benchmark'
...
def test_win_vol():
    path = PureWindowsPath(r"C:\Users\myuser\Projects")
    assert win_vol(path) == "/C/Users/myuser/Projects"


def test_win_vol_posix():
    path = PurePosixPath('/Users/myuser/Projects')
