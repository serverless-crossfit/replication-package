...
def win_vol(path) -> str:
    ...
    Example: win_vol(PureWindowsPath("C:\Users\myuser\Projects"))
...
class BenchmarkSpec:
    ...
    def run(self, cmd, image='alpine:3.12.0',
        ...
        * check: fails upon non-zero exit status if set to True.
        ...
        # MAYBE: provide option to execute in full local mode too.
    ...
    def sub_path(self):
        ...
        * str(self.host_path()) ==
            '/Users/myuser/Projects/Serverless/serverless-benchmarker/tests/fixtures/higher_root_path/azure'
        * self['root'] == '..'
